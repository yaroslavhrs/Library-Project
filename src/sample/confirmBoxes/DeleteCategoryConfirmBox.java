...
public class DeleteCategoryConfirmBox {
    ...
    public void display(Category category) {
        ...
        label.setText("Ви справді хочете видалити розділ " + category.getCategory() + "?");
        ...
        yesButton.setOnAction(event -> {
            if (category.getId() != 1) {
                ...
                OKConfirmBox.display("OK", "Розділ було успішно видалено!");
            }
        });
