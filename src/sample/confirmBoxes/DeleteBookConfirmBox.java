...
public class DeleteBookConfirmBox {

    public void display(String title, String message, Book book) {
        Stage popWindow = new Stage();
        popWindow.setTitle(title);
        popWindow.setMinWidth(420);
        ...
        yesButton.setOnAction(event -> {
            if (book != null) {
                ...
                OKConfirmBox.display("OK", "Книгу було успішно видалено!");
            }
        });
